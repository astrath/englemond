...
?>
<!-- wp:cover {"metadata":{"name":"Couverture 3", "patternName":"englemond/cover-3", "categories":["banner"]},"url":"<?=$image['url'];?>","id":<?=$image['id'];?>,"dimRatio":0,"contentPosition":"bottom center","sizeSlug":"full","align":"full","className":"pattern-cover-3","layout":{"type":"constrained"}} -->
