	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column">
			...
			<figure class="wp-block-image size-full">
				<img src="/wp-content/themes/englemond/assets/images/404-image.webp" alt="<?php echo esc_attr_x( 'Small totara tree on ridge above Long Point', 'image description', 'twentytwentyfive' ); ?>" style="object-fit:cover"/>
			</figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->
