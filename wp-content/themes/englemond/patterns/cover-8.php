...
?>
<!-- wp:cover {"metadata":{"name":"Couverture 8"},"templateLock":"all","url":"<?=$image['url'];?>","id":<?=$image['id'];?>,"dimRatio":0,"contentPosition":"bottom center","sizeSlug":"full","align":"full","className":"pattern-cover-8","layout":{"type":"constrained"}} -->
